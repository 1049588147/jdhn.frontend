...
<body>
	<div align="center">
        <ul>
            <li style="background-color:#FF7F24"><a href="http://www.jdhn.top/pay/example/jsapi.php">JSAPI支付</a></li>
            ...
            <li style="background-color:#CDCD00"><a href="http://www.jdhn.top/pay/example/orderquery.php">订单查询</a></li>
            <li style="background-color:#CD3278"><a href="http://www.jdhn.top/pay/example/refund.php">订单退款</a></li>
